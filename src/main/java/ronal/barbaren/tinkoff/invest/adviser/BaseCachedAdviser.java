...
import ronal.barbaren.tinkoff.invest.adviser.utils.CandleUtils;
import ronal.barbaren.tinkoff.invest.adviser.utils.OperationUtils;
...
@Deprecated
public abstract class BaseCachedAdviser extends BaseTimeAdviser {
    ...
    public BaseCachedAdviser(Api api, Environment env) {
        super(api, env);
    }
}
